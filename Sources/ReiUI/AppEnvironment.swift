...
public final class AppEnvironment {
    ...
    public static func standard(appLog: AppLog) throws -> AppEnvironment {
        AppEnvironment(
            store: try ReiStore.defaultLocation(),
...
public enum ProtocolChoice: String, Codable, Sendable, CaseIterable, Identifiable {
    ...
    /// The canonical NoneBot route used when Rei initiates a reverse WebSocket.
...
enum SettingsStorage {
    private static let settingsKey = "rei.connection.settings"
    private static let protocolKey = "rei.connection.protocol"
    private static let activeUserKey = "rei.persona.active-user"
    private static let botUserKey = "rei.persona.bot-user"
    private static let settingsSchemaVersionKey = "rei.connection.settings.schema-version"
