...
public final class AppLog: Sendable {
    private static let activeFileName = "Rei.jsonl"
    private static let exportedLogFileName = "rei-logs.jsonl"
    private static let exportedSummaryFileName = "rei-log-summary.json"
    ...
    private struct PipelineState: Sendable {
        ...
        var lockFileURL: URL {
            logDirectory.appendingPathComponent(".Rei.lock")
        }
    ...
    /// Serializes file mutation across every Rei process using this cache directory.
