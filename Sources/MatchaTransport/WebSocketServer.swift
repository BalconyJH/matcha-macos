...
///
/// This is the forward direction in OneBot terms: the framework dials Matcha, the
...
public final class WebSocketServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "matcha.ws.server")
    ...
    public func start() async throws {
        ...
        // Bot frameworks commonly run on the same machine as Matcha.
