...
struct OneBotWireTests {
    ...
    private func groupMessageEvent(
        _ fixture: (
            store: ReiStore, platform: PlatformService, adapter: OneBotProtocolImplementation,
    ...
    func v12Envelope() async throws {
        ...
        #expect(selfObject["platform"]?.stringValue == "rei")
    ...
    func asyncSuffixIsStripped() async throws {
        ...
        // Rei answers everything promptly, so `_async` is a naming detail only.
        #expect(reply.retcode == 0)
